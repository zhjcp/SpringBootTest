...
- IDEA设置统一编码，防止乱码<img src="https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308132824.png" alt="image-20210123212212973" style="zoom:80%;" />
  ...
  ![image-20210123212255234](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308132828.png)
...
- **Shiro的外部架构** ，即从应用程序角度的来观察如何使用 Shiro 完成工作：
  ...
  ![img](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308132955.png)
...
- **Shiro的内部架构**：
  ...
  ![img](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308132959.png)
...
- **运行结果**
  ...
  ![image-20210204184011599](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133007.png)
...
- **Shiro & Mybatis 认证、授权、加密**
  ...
  - 加密：
    ...
    - 加密源码 `AuthorizingRealm-(父类)->AuthenticatingRealm-(方法)->getCredentialsMatcher()`
      ...
      ![image-20210205165953082](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133018.png)

    - 自定义或选择其他Shiro自带的加密方式

      如图，`CredentialsMatcher`接口就是上面提到的方法返回值，该接口有多个实现类，对应不同加密方式

      ![image-20210205170604103](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133025.png)
...
- **过滤器和授权的巧妙联动**
  ...
  - ``doGetAuthenticationInfo`里面可以授予用户权限，且返回null表示没有权限
    ...
    ![image-20210205205623524](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133031.png)
...
- **运行测试**
  ...
  ![image-20210206212141638](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133038.png)
...
- **自定义Swagger信息**
  ...
  - 运行测试
    ...
    ![image-20210206225100810](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133042.png)
...
- 示例
  ...
  ![image-20210207212813240](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133047.png)
...
- 测试效果：
  ...
  ![image-20210207215648534](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133051.png)
...
- **要测试谁的接口就选谁的API文档**
  ...
  ![image-20210207221132575](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133054.png)

- **根据提示输入数据即可测试请求**

  ![image-20210207221747488](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133059.png)

  ![image-20210207222349360](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133111.png)

![image-20210207222238339](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133102.png)
...
- **相关依赖**
  ...
  - `JavaMailSenderImpl`已经实现了一些邮件操作，拿来即可使用，如下图：
    ...
    ![image-20210208155541717](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133120.png)

    

- **开启邮箱协议**

  ![image-20210208154108156](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133126.png)

  ![image-20210208160313324](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133132.png)
...
- 随着互联网的发展，网站应用的规模不断扩大，常规的垂直应用架构已无法应对，分布式服务架构以及流动计算架构势在必行，亟需一个治理系统确保架构有条不紊的演进。
  ...
  ![image](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133141.jpg)
...
- ##### Dubbo架构
  ...
  ​	<img src="https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133147.jpg" alt="dubbo架构" style="zoom:50%;" />
...
- zookeeper下载地址：https://archive.apache.org/dist/zookeeper/
  ...
  ![image-20210209175336427](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133153.png)

  

- 启动Zookeeper：

  - 加上一个`pause`防止闪退![image-20210209175754847](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133157.png)

  - 将conf目录下的.cfg文件复制一份，并命名为zoo.cfg

    ![image-20210209192516435](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133208.png)

    ![image-20210209192829293](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133203.png)

  - Zookeeper运行结果

    - 运行`zkServer.cmd`  ---> 启动服务端

      ![image-20210209192548990](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133215.png)

    - 运行 `zkCli.cmd`  ---> 启动客户端  连接到cfg中指定的2081端口

      ![image-20210209193145344](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133223.png)
...
- zookeeper的cmd命令
  ...
  ![image-20210209202851789](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133227.png)
...
- **安装步骤**
  ...
  - 打包dubbo-admin项目
    ...
    - IDEA + Maven 打包
      ...
      - maven打包
        ...
        ![image-20210209210149371](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133231.png)
  ...
  - 在dubbo-admin\target下执行生成的jar包
    ...
    ![image-20210209212209354](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133236.png)
...
- 消费者请求了消费
  ...
  - 把提供者的服务接口（非实现类）复制到消费者工程下，以便@DubboReference生效（待测试）
    ...
    ![image-20210209233636760](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133241.png)
...
- 测试结果
  ...
  - Zookeeper与provider、consumer关联
    ...
    ![image-20210209232620648](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133244.png)

  - 消费者请求服务成功

    ![image-20210209232544465](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133250.png)

  - dubbo-admin监控情况

    ![image-20210209233214612](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133256.png)

    ​	![image-20210209233302497](https://raw.githubusercontent.com/zhjcp/PicGoResp/main/SpringbootTest/20210308133303.png)
